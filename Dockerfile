...
RUN ( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | $ANDROID_HOME/tools/android update sdk --no-ui -a --filter platform-tool,build-tools-23.0.3,android-22,extra-android-m2repository
